  ...
  const products = [
    {
      ...
      description:
        "Heavy-duty scissors for hardware and industrial applications",
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        ...
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            SINSEUNG hardware scissors are engineered with advanced heat
            treatment technology for superior durability and cutting
            performance. Our scissors are designed for professional use in
            hardware, electrical, and industrial applications.
          </p>
        </div>
