  ...
  const news = [
    {
      ...
      date: "2025/11/15",
      excerpt:
        "SINSEUNG introduces our new line of heat-treated scissors with superior durability and cutting performance, setting new industry standards.",
    ...
    },
    {
      ...
      date: "2025/10/28",
      excerpt:
        "Our new 25mm heavy-duty blades feature enhanced cutting power for industrial applications, with improved blade life and precision.",
    ...
    },
    {
      ...
      date: "2025/09/20",
      excerpt:
        "Launch of our new ergonomic garden tools collection designed for professional landscapers with enhanced comfort and durability.",
    ...
    },
    {
      ...
      date: "2025/08/12",
      excerpt:
        "Introduction of our precision utility knives series featuring advanced blade retention systems and safety features.",
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        ...
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Discover the latest product innovations and releases from SINSEUNG.
            Our products news covers new cutting tools, technological
            advancements, and improvements to our existing product lines that
