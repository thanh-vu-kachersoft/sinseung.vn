          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  SINSEUNG TOOLS CORPORATION collects information you provide directly to us, such as when you:
                </p>
                ...
                <p>
                  Types of information we may collect include name, email address, phone number, company name, 
                  job title, and other business-related information.
                </p>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-zinc-900 mb-4">5. Cookies and Tracking</h2>
              <div className="space-y-4 text-gray-600">
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  As an international company, we may transfer your personal information across borders. 
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <p><strong>Email:</strong> sinseung3@sinseungok.com</p>
                  <p><strong>Phone:</strong> +86-532-8726-9289</p>
                  <p><strong>Address:</strong> 796, Agok-ri, Whegwan-eup, Chilgok-gun, Kyungbuk, South Korea</p>
                </div>
              </div>
            </section>
          </div>
