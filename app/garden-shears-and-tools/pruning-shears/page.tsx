      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        ...
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Our professional pruning shears are designed for precision cutting
            and plant health. With sharp blades and ergonomic designs, these
            tools make pruning tasks efficient and comfortable for both
