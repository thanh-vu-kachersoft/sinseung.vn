export default function GardenTools() {
  const products = [
    ...
    },
    {
      ...
      description:
        "Compact garden tools for small spaces and container gardening",
      pieces: "4 Piece",
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        ...
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Our comprehensive range of garden tools includes everything you need
            for successful gardening. From basic hand tools to specialized
            equipment, each tool is designed for durability, comfort, and
            optimal performance in garden applications.
          </p>
        </div>
