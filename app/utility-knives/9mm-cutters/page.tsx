  ...
  const products = [
    {
      ...
      features: ["Retractable blade", "Blade storage", "Pocket clip", "Safety lock"]
    },
    {
      id: "SSK-9-002", 
      ...
      features: ["Metal construction", "Quick blade change", "Ergonomic grip", "Blade lock"]
    },
    {
      id: "SSK-9-003",
      ...
      features: ["Folding design", "Safety lock", "Keychain attachment", "Compact size"]
    }
  ];
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        <h1 className="text-4xl font-extrabold text-zinc-900 mb-8">9mm Cutters</h1>
        
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Our 9mm utility knives are designed for precision cutting and portability. 
            Perfect for office work, light industrial applications, and everyday cutting tasks.
          </p>
        </div>
