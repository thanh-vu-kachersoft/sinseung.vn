...
export async function GET() {
  try {
    ...
    const transformedBanners = wordpressBanners.map((banner: any) => ({
      ...
      alt_text: banner.acf?.alt_text || banner.title?.rendered || 'Banner image'
    }));
    ...
    const fallbackBanners = [
      {
        ...
        description: "High-quality precision cutting solutions for professional applications",
        image: "https://www.sinseungok.com/wp-content/uploads/2025/08/banner1.jpg",
        link: "/cutter-blades",
      ...
      },
      {
        ...
        description: "Advanced heat treatment technology for exceptional durability",
