  ...
  const products = [
    {
      ...
      description:
        "High-quality standard 9mm snap-off blade for general purpose cutting",
      segments: 9,
      thickness: "0.38mm",
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        ...
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Our 9mm cutter blades are the industry standard for utility knives
            and cutting tools. Designed for versatility and reliability, these
            blades are perfect for general purpose cutting applications in
            offices, workshops, and industrial settings.
          </p>
        </div>
