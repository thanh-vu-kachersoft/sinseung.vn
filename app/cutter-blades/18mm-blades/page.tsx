  ...
  const products = [
    {
      ...
      description: "Industrial-grade 18mm blade for heavy-duty cutting applications",
      segments: 9,
      thickness: "0.50mm",
      material: "Alloy Steel",
      applications: ["Industrial cutting", "Heavy materials", "Construction", "Manufacturing"]
    },
    {
      id: "SSB-18-002", 
      ...
      applications: ["Thick plastics", "Carpet", "Rubber", "Composite materials"]
    },
    {
      id: "SSB-18-003",
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        <h1 className="text-4xl font-extrabold text-zinc-900 mb-8">18mm Blades</h1>
        
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Our 18mm cutter blades are designed for heavy-duty industrial applications. 
            With increased width and thickness, these blades provide superior strength and 
            durability for cutting through tough materials in demanding work environments.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-zinc-900 mb-6">Industrial Grade Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-zinc-900 mb-3">Enhanced Durability</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-zinc-900 mb-3">Heavy Duty Performance</h3>
              <ul className="space-y-2 text-gray-600">
        ...
        <div className="bg-orange-50 rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-zinc-900 mb-4">Industrial Applications</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Manufacturing", "Construction", "Automotive", "Shipbuilding", "Aerospace", "Packaging", "Textiles", "Metalworking"].map((app) => (
