  ...
  const products = [
    {
      id: "SSB-SS-001",
      name: "Hook Blade",
      description: "Curved hook blade for cutting roofing materials and shingles",
      segments: 5,
    ...
    },
    {
      ...
      applications: ["Glass scoring", "Tile scoring", "Acrylic", "Plastic sheets"]
    },
    {
      id: "SSB-SS-004",
      name: "Concave Blade",
      ...
      applications: ["Pipe cutting", "Hose cutting", "Tubing", "Specialized industrial"]
    }
  ];
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto w-full max-w-[1440px] px-4 py-16">
        <h1 className="text-4xl font-extrabold text-zinc-900 mb-8">Special Shaped Blades</h1>
        
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-gray-600">
            Our special shaped blades are engineered for specific cutting applications where 
            standard blades may not provide optimal performance. Each specialized design addresses 
            unique cutting challenges across various industries and materials.
          </p>
        </div>
        ...
        <div className="bg-purple-50 rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-zinc-900 mb-4">Specialized Applications</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Roofing", "Textiles", "Glass Work", "Plumbing", "Flooring", "Crafts", "Automotive", "Marine"].map((app) => (
